...
* The graphs and model output helped us see that incidents were not evenly spread across the dataset. Some incident types happened more often than others, and incident counts also changed across year, season, and weather conditions. However, after working with the data more, we realized that some of our most important variables, like incident type and death or injury, are categorical. Because of that, logistic regression may have been a better model choice if we were trying to predict a category such as death or injury. Since we realized this late in the project, we kept the linear model as an exploratory model for incident counts, but we recognize this as a limitation and a possible improvement for future work.
