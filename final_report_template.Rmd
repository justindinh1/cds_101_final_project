...
```{r eda-scatter-plot, message=FALSE, warning=FALSE, fig.cap="Relationship between time of year and weather related equine incidents"}
library(ggplot2)
...
Equine_Death_and_Breakdown %>%
  filter(`Incident Type` %in% c(
    "EQUINE DEATH",
    "STEWARDS/VETS LIST",
    "RACING INCIDENT",
    "RACING INJURY",
  ...
  count(Year, `Incident Type`) %>%
  ggplot(aes(x = Year, y = n)) +
  geom_point() +
  geom_smooth(method = "lm") +
  facet_wrap(~ `Incident Type`, scales = "free_y") +
  labs(
